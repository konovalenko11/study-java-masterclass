...
type boolean called duplex. All three fields will have private access.
...
parameter.   A conditional check should be performed on whether the
Printer class field, duplex, is either "true" or "false". If "true" then a
...
are two operators which can help you with this. The division "/" operator
divides a number and returns only the quotient without any remainder. And the
modulo "%" operator divides the number and returns only the remainder, whether 0
or otherwise.
 */
...
public class Main_Challenge {
    public static void main(String[] args) {
        ...
        System.out.println("Toner level: " + printer2.addToner(1));
    }
}