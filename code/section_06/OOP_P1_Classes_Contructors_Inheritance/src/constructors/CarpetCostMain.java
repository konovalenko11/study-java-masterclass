...
to 0, in case the length parameter is less than 0 it needs to set the length
field value to 0.
...
In case the cost parameter is less than 0 it needs to set the cost field value
to 0.
...
3. Write a class with the name Calculator. The class needs two fields (instance
