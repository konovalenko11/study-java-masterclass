...
public class MinutesToYearsDaysCalculator {
    ...
    public static void printYearsAndDays (long minutes) {
        ...
        final int minutesInDay = 24 * minutesInHour;
        final int minutesInYear = 365 * minutesInDay;

        long resultYears = minutes / minutesInYear;
        long minutesMinusYears = minutes % minutesInYear;
        long resultDays = minutesMinusYears / minutesInDay;
