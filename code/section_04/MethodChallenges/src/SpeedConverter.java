/*
    ...
    * printConversion(75.114); → should print the following text
    ...
    long. The method returns the value of the argument rounded to the nearest
    int value.
    ...
    TIP: In the method printConversion, call the method toMilesPerHour instead
...
public class SpeedConverter {
    ...
    public static long toMilesPerHour (double kilometersPerHour) {
        final double milesInKilometer = 1.609;

        if (kilometersPerHour < 0) {
            return (long) -1;
        }

        return (long)Math.round(kilometersPerHour / milesInKilometer);
    }
