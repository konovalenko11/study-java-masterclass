...
public class DecimalComparator {
    public static void main(String[] args) {
        areEqualByThreeDecimalPlaces(3175.23, 1);
        areEqualByThreeDecimalPlaces(3175.83, 1);
        areEqualByThreeDecimalPlaces(3.17583, 1);
        areEqualByThreeDecimalPlaces(4000, 1);
    }

    public static boolean areEqualByThreeDecimalPlaces (double d1, double d2) {
        int coefficient = 1000;
        return (long)(d1 * coefficient) == (long)(d2 * coefficient);
    }
}
