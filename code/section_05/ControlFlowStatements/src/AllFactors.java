/*
    ...
    an integer which divides that number wholly (i.e. without leaving a
    remainder).
    ...
    * printFactors(-1); → should print "Invalid Value" since number is < 1
    ...
    NOTE: The method printFactors should be defined as public static like we
...
public class AllFactors {
    ...
    public static void printFactors (int number) {
        ...
        // There is no need to look at factors that are higher than number / 2,
        // as this is the highest possible divisible number except the number by
        // itself.
        for (int i = 1; i <= (number/2); i++) {
            if (number % i == 0) System.out.println(i);
        }

        // Number by itself is the highest factor.
