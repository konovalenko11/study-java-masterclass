/*
    ...
    * getDaysInMonth(2, 2020); → should return 29 since February has 29 days in
    a leap year and 2020 is a leap year.

    * getDaysInMonth(2, 2018); → should return 28 since February has 28 days if
     it's not a leap year and 2018 is not a leap year.

    * getDaysInMonth(-1, 2020); → should return -1 since the parameter month
    is invalid.
...
public class NumberOfDaysInMonth {
    ...
    public static boolean isLeapYear (int year) {
        ...
        // Non-leap year, because is non-divisible by 4.
        if (year % 4 > 0) return false;

        // Leap year because it is divisible by 4 and non-divisible by 100.
        if (year % 100 > 0) return true;

        // Leap year because it is divisible by 100 and by 400.
