/*
    ...
    when reversed is equal to the original number. For example: 121, 12321, 1001
    etc.
    ...
    If both are the the same then the number is a palindrome otherwise it is
    not.
...
public class NumberPalindrome {
    public static void main(String[] args) {
        ...
        System.out.printf("Number [%s]: %s;\n", 11, isPalindrome(11));
        System.out.printf("Number [%s]: %s;\n", -222, isPalindrome(-222));
        System.out.printf("Number [%s]: %s;\n", 11255211,
                isPalindrome(11255211));
    }
    ...
    public static boolean isPalindrome (int number) {
        ...
        while (checkNumber > 0) {
            reversedNumber = reversedNumber * 10 + checkNumber % 10;
            checkNumber /= 10;
        }
