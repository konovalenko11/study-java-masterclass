/*
    ...
    1. Write a method named getBucketCount with 4 parameters. The first
       parameter should be named width of type double. This parameter represents
    ...
    0 or if extraBuckets is less than 0, the method needs to return -1 to
    ...
    * getBucketCount(3.4, 2.1, 1.5, 2); → should return 3 since the wall area
      is 7.14, a single bucket can cover an area of 1.5 and Bob has 2 extra
      buckets home.

    * getBucketCount(2.75, 3.25, 2.5, 1); → should return 3 since the wall area
      is 8.9375, a single bucket can cover an area of 2.5 and Bob has 1 extra
      bucket at home.
    ...
    * getBucketCount(-3.4, 2.1, 1.5); → should return -1 since the width
      parameter is invalid
    ...
    * getBucketCount(3.26, 0.75); → should return 5 since the wall area is 3.26,
    ...
    NOTE: Use the method Math.ceil to round the number of calculated buckets
          (double) then convert it into an int before returning the value from
          the methods.
